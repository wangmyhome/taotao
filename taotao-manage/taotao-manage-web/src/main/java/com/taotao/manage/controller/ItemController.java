...
public class ItemController {
    ...
    public ResponseEntity<Void> saveItem(Item item, @RequestParam("desc") String desc,
        ...
        try {
            ...
            //保存商品的基本数据
            this.itemServive.saveItem(item, desc,itemParams);
            if(LOGGER.isInfoEnabled()){
    ...
    public ResponseEntity<EasyUIResult> queryItemList(
        ...
        try {
            PageInfo<Item> pageInfo = this.itemServive.queryPageList(page, rows);
    ...
    public ResponseEntity<Void> updateItem(Item item, @RequestParam("desc") String desc,
        ...
        try {
            ...
            this.itemServive.updateItem(item, desc,itemParams);
            if(LOGGER.isInfoEnabled()){
    ...
    public ResponseEntity<Item> queryById(@PathVariable("itemId") Long itemId){
        try {
            Item item = this.itemServive.quertById(itemId);
            if(null == item){
